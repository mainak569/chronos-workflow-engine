...
public class TaskExecution {
     ...
     * Automatically incremented by Spring Data on each save.
     * Prevents lost updates when multiple workers try to update the same task.
     */
    @Version
    private Long version;
    
    /**
     * Timestamp of the last retry attempt (null if never retried).
     */
    private Instant lastAttemptAt;
    
    /**
     * Scheduled timestamp for the next retry attempt (null if not scheduled).
     * Used to implement exponential backoff between retries.
     */
    ...
    /**
     * Schedule a retry for this task.
     * Increments attempt number and sets nextRetryAt based on the provided backoff delay.
     */
    public void scheduleRetry(Instant nextRetryAt) {
        ...
        this.status = ExecutionStatus.PENDING; // Reset to PENDING for retry
    ...
    public static class Builder {
        ...
        public TaskExecution build() {
            ...
            execution.setLastAttemptAt(lastAttemptAt);
